...
{
    AZ_COMPONENT_IMPL(GenAISampleFeaturesEditorSystemComponent, "GenAISampleFeaturesEditorSystemComponent",
        GenAISampleFeaturesEditorSystemComponentTypeId, BaseSystemComponent);

    void GenAISampleFeaturesEditorSystemComponent::Reflect(AZ::ReflectContext* context)
    {
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serializeContext->Class<GenAISampleFeaturesEditorSystemComponent, GenAISampleFeaturesSystemComponent>()
                ->Version(0);
        }
    }
    ...
    void GenAISampleFeaturesEditorSystemComponent::GetRequiredServices([[maybe_unused]] AZ::ComponentDescriptor::DependencyArrayType& required)
    {
        BaseSystemComponent::GetRequiredServices(required);
    }

    void GenAISampleFeaturesEditorSystemComponent::GetDependentServices([[maybe_unused]] AZ::ComponentDescriptor::DependencyArrayType& dependent)
    {
