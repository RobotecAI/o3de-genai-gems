...
namespace AICore
{
    class OllamaContextRequestGeneratorController
        : public RequestGeneratorBus<Aws::Utils::Json::JsonValue, AZStd::pair<AZStd::string, AZStd::vector<int>>>::Handler
    {
    public:
        ...
        // RequestGeneratorBus
        Aws::Utils::Json::JsonValue PrepareRequest(AZStd::pair<AZStd::string, AZStd::vector<int>> prompt) override;
        AZ::Outcome<AZStd::pair<AZStd::string, AZStd::vector<int>>, AZStd::string> ProcessRequest(
